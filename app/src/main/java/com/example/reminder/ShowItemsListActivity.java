...
public class ShowItemsListActivity extends AppCompatActivity implements ItemsListAdapter.HandleItemsClick {
    ...
    private com.example.reminder.viewmodel.ShowItemListActivityViewModel viewModel;
    ...
    private void initViewModel() {
        viewModel = new ViewModelProvider(this).get(com.example.reminder.viewmodel.ShowItemListActivityViewModel.class);
